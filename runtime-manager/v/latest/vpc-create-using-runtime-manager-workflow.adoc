= Workflow: Creating a VPC Using Runtime Manager
...
To be able to create a VPC, your organization needs to purchase a link:https://www.mulesoft.com/platform/services/vpc-virtual-private-cloud[VPC offering] and your account needs to meet the link:/runtime-manager/virtual-private-cloud-permissions-about[necessary permissions] to create and administrate a VPC.

This tutorial assumes that you are familiar with link:/runtime-manager/virtual-private-cloud-about[Virtual private Cloud terminology], and link:/runtime-manager/cloudhub-architecture[CloudHub architecture].
...
This option allows you to link:/runtime-manager/virtual-private-cloud-internal-dns-about[set up internal DNS servers] to resolve your private host names.
...
[NOTE]
--
Additionally, you can link:/runtime-manager/vpc-create-using-cli-workflow[create a VPC using the Anypoint Platform CLI].
--
...
link:/runtime-manager/virtual-private-cloud-connectivity-methods-about[VPC connectivity methods] (IPSEC, AWS Peering, etc) are not a self-serve function at this time. +
